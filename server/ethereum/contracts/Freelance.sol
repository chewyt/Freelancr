...
contract ContractFactory {
    ...
    function createContract (uint budget) public{
        address newContract = address(new freelancer(budget,msg.sender));
...
contract freelancer{
    ...
    constructor(uint budget,address creator)
    {
    ...
    payable
    {
        addSchedule('DP','Design Phase',budget_amt);
        acceptProject();
        fundTask(0);
    }
