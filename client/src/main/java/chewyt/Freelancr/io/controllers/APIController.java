...
public class APIController {
    ...
    @GetMapping(path="/type/{auth_token}")
    public ResponseEntity<String> getUserCreds(@PathVariable String auth_token){
        ...
        try {
            ...
            userCredentials = userRepository.getUserCreds(auth_token);
        ...
        logger.info("User type sent to front end successfully");
        return ResponseEntity.ok(userCredentials.toJSON().toString());  
    }
